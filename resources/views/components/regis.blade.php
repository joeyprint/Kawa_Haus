<section id="regis">
    <div class="container">
        <div class="row justify-content-center text-center">
            ...
            <div class="col-12">
                <p class="kawa-text no-margin">KAWA HAUS อ่อนนุช T77</p>
            </div>
            <div class="col-12">
                <p class="call-text no-margin">Call Centre 1685<br class="d-block d-lg-none"><span class="d-none d-lg-inline"> | </span>kawahaus@sansiri.com</p>
            </div>
        </div>
